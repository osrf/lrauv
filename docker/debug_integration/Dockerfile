...
# Use current version of the code: Change to local branch if needed.
COPY . src/lrauv
...
ENTRYPOINT tmuxinator start debug_and_plot -n debug_session -p src/lrauv/docker/debug_integration/mux.yml
